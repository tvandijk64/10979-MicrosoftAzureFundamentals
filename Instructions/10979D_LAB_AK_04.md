...
16.   Select the **Pin to dashboard** check box, and then click **Create**.
    > **Note:** Wait until the web app is created, which might take a couple of minutes.

17.   After it is created, the WordPress web app blade will open automatically in the Azure portal interface.
