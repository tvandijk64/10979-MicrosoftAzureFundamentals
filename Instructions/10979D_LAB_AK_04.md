...
15. Ensure that **Application Insights** setting is set to **Off**.
16. Click **Create**.

> **Note:** Wait until the web app is created, which might take a couple of minutes.

17. Click **Pin to dashboard** on the **Deployment succeeded** notification.
18. On dashboard, click the tile representing the WordPress Web app that you created.  
...
3. On the Welcome page, complete the **Information needed** section with the following:
  ...
  - Site Title: **Adatum Blog ######** (_where **######** is a unique number_)
...
6. Wait until the cloud service is created. This should take only a few seconds. 
7. Click **Pin to dashboard** on the **Deployment succeeded** notification.
